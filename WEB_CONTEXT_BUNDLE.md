...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-304-erd-s-problem-304-797f57fb-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-304"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-304-erd-s-problem-304-797f57fb-v1",
      "problem_contract_sha256": "6170b14bd1a62de4e7c11039c93020a9b31e7e29f83b33cce9e2609c92038e5e",
      "problem_id": "problem:um-ep-304-erd-s-problem-304-797f57fb",
      "route_id": "route:um-ep-304-erd-s-problem-304-797f57fb-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-304-erd-s-problem-304-797f57fb-source-fidelity-01",
      "graph_id": "graph:um-ep-304-erd-s-problem-304-797f57fb-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-304-erd-s-problem-304-797f57fb-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-304-erd-s-problem-304-797f57fb-root",
          "statement": {
          ...
          "statement_sha256": "bc06ff0278ed99aea4c6aeef0501479b3391a388f2b8846d11cbc2750aff79f8"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-304-erd-s-problem-304-797f57fb-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-304-erd-s-problem-304-797f57fb-root",
      "route_id": "route:um-ep-304-erd-s-problem-304-797f57fb-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-304-e4d101aa678e",
        "url": "https://www.unsolvedmath.com/problems/EP-304"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
